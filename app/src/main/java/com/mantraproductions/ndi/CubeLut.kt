...
object CubeLut {
    ...
    fun generate(from: LogCurves.Curve, to: LogCurves.Curve, size: Int): String {
        // 65 is the largest anything reads and 512 cubed is 134 million
        // entries and several gigabytes of text, which is a hang rather than a
        // file. Refused here rather than attempted and abandoned halfway.
        require(size in 2..65) { "a cube must be between 2 and 65 points" }
        return buildString {
